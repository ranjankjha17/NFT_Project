const data=[
    {
        id:1,
        image:"https://img.icons8.com/ios/344/sell.png",
    ...
    {
        id:1,
        image:"https://img.icons8.com/ios-filled/452/wallet.png",
...
const styles={
    card: `h-auto h-[22rem] w-[22rem] rounded-xl border border-slate-300 px-5 py-5 my-5 md:my-0 bg-gray-200 md:mb-[5rem] flex-wrap justify-center items-center`,
}
                    ...
                    data.map((el)=>(
                        <div className={styles.card} key={el.id}>
                            <div className="flex justify-center items-center w-[5rem] h-[5rem] bg-blue-100 rounded-full my-10 mx-24">
                                <img src={el.image} alt="symbol" className="h-10 w-10 text-gray-600"/>
                            </div>
